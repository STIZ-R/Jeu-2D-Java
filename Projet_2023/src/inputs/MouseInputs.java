/*
 *   Nom de la Classe: MouseInputs
 * 
 * 	 Description: La class MouseInputs permet la msie en place de l'utilisation de la souris
 *   
 *   Version: 1.0
 *  
...
public class MouseInputs implements MouseListener, MouseMotionListener {
	...
	public void mouseClicked(MouseEvent e) {
		...
		switch(Gamestate.state) {
		case PLAYING:
			gamePanel.getGame().getPlaying().mousClicked(e);
			break;
		default:
			break;
